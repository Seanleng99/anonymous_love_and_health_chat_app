...
class _ChatRoom extends StatefulWidget {
  ...
  _ChatRoom({Key key, @required this.peerId, @required this.peerAvatar})
      : super(key: key);

  @override
  State createState() =>
      _ChatRoomState(peerId: peerId, peerAvatar: peerAvatar);
}

class _ChatRoomState extends State<_ChatRoom> {
  _ChatRoomState({Key key, @required this.peerId, @required this.peerAvatar});
